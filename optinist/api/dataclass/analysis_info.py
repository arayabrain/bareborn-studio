...
if __name__ == '__main__':
    ...
    wf_input_file_path_list = [
        ...
        'proj_root/mouse3/sub-mouse3_ses-202305031123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse4/sub-mouse4_ses-20230504123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse5/sub-mouse5_ses-20230505123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse6/sub-mouse6_ses-20230506123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse7/sub-mouse7_ses-20230507123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse8/sub-mouse8_ses-20230508123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse9/sub-mouse9_ses-20230509123456_rec-1_run-1_T2W.nii',
        'proj_root/mouse10/sub-mouse10_ses-20230510123456_rec-1_run-1_T2W.nii']
    ...
    for wf_input_path in wf_input_file_path_list:
        ...
        if count % 2 == 0:
            ...
            analysis_info.set_analysis_status(wf_input_path, AnalysisStatus.ERROR)
        count += 1

    # ===== Test each method of the AnalysisInfo object. =====

    print(f'\n[project_path] {analysis_info.project_path}')

    results = analysis_info.workflow_input_file_path_list
    print('\n[workflow_input_file_path_list]')
    for result in results:
        print(result)

    results = analysis_info.get_subject_list()
    print('\n[get_subject_list]')
    for result in results:
        print(result)

    print(f'\n[get_factors]\n{analysis_info.get_factors()}')

    results = analysis_info.get_output_file_paths(wf_input_file_path_list[0])
    print('\n[get_output_file_paths]')
    for result in results:
        print(result)

    results = analysis_info.search_output_file_paths(
        [
            'proj_root/mouse1/sub-mouse1_ses-20230501123456_rec-1_run-1_T2W.nii',
            'proj_root/mouse2/sub-mouse2_ses-20230502123456_rec-1_run-1_T2W.nii',
            'proj_root/mouse3/sub-mouse3_ses-202305031123456_rec-1_run-1_T2W.nii',
        ...
        ['mouse2', 'mouse5'],
        '20230502123456')
    print('\n[search_output_file_paths]')
    for result in results.items():
        print(result)

    print(f'\n[get_unit_analysis_status]\n{analysis_info.get_unit_analysis_status(wf_input_file_path_list[0])}')

    print(f'\n[get_node_analysis_status]\n{analysis_info.get_node_analysis_status()}')
